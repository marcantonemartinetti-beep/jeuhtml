...
function getWeaponTex(type, level) {
  ...
  } else if (type === 'coral') { // Scenery
    ctx.fillStyle = base;
    ctx.beginPath(); ctx.moveTo(32, 64); ctx.quadraticCurveTo(10, 30, 20, 10); ctx.quadraticCurveTo(40, 30, 32, 64); ctx.fill();
    ctx.beginPath(); ctx.moveTo(32, 64); ctx.quadraticCurveTo(54, 30, 44, 10); ctx.quadraticCurveTo(24, 30, 32, 64); ctx.fill();
  } else if (type === 'tech') { // Scenery
    ctx.fillStyle = '#222'; ctx.fillRect(20, 10, 24, 54);
    ctx.fillStyle = '#0f0'; ctx.fillRect(24, 20, 16, 4); ctx.fillRect(24, 30, 16, 4); ctx.fillRect(24, 40, 16, 4);
  } else if (type === 'organic') { // Scenery
    ctx.fillStyle = '#664422'; ctx.beginPath(); ctx.moveTo(32, 64); ctx.quadraticCurveTo(10, 30, 32, 10); ctx.quadraticCurveTo(54, 30, 32, 64); ctx.fill();
    ctx.fillStyle = '#442200'; ctx.beginPath(); ctx.arc(32, 30, 10, 0, Math.PI*2); ctx.fill();
  }
